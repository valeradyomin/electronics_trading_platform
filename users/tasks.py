...
def send_mail_confirmation(user_email, confirmation_code):
    ...
    subject = 'Подтверждение регистрации на онлайн платформе торговой сети электроники.'
...
def send_mail_notification(user_email):
    ...
    subject = 'Уведомление о регистрации на онлайн платформе торговой сети электроники.'
...
def send_mail_notification_user_not_active(user_email):
    ...
    subject = 'Уведомление о статусе аккаунта на онлайн платформе торговой сети электроники.'
