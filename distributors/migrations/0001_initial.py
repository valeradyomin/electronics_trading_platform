# Generated by Django 4.2.7 on 2024-05-07 22:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier_structure', models.CharField(choices=[('завод', 'завод'), ('розничная сеть', 'розничная сеть'), ('индивидуальный предприниматель', 'индивидуальный предприниматель')], default='завод', max_length=255, verbose_name='структура поставщика')),
                ('tn_parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='distributors.supplier', verbose_name='Parent')),
            ],
            options={
